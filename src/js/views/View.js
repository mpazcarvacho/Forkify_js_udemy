//This is the parent class. We export the actual class as we will not create any instance of this view.
...
export default class View {
   ...
   * @param {boolean} [render=true] If false, create markip string instead of rendering to the DOM
